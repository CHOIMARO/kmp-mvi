...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class SqlLibraryAccessors extends SubDependencyFactory {
        private final SqlAndroidLibraryAccessors laccForSqlAndroidLibraryAccessors = new SqlAndroidLibraryAccessors(owner);
        private final SqlCoroutinesLibraryAccessors laccForSqlCoroutinesLibraryAccessors = new SqlCoroutinesLibraryAccessors(owner);
        private final SqlJvmLibraryAccessors laccForSqlJvmLibraryAccessors = new SqlJvmLibraryAccessors(owner);
        private final SqlNativeLibraryAccessors laccForSqlNativeLibraryAccessors = new SqlNativeLibraryAccessors(owner);

        public SqlLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>sql.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SqlAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSqlAndroidLibraryAccessors;
        }

        /**
         * Group of libraries at <b>sql.coroutines</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SqlCoroutinesLibraryAccessors getCoroutines() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSqlCoroutinesLibraryAccessors;
        }

        /**
         * Group of libraries at <b>sql.jvm</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SqlJvmLibraryAccessors getJvm() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSqlJvmLibraryAccessors;
        }

        /**
         * Group of libraries at <b>sql.native</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SqlNativeLibraryAccessors getNative() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSqlNativeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SqlAndroidLibraryAccessors extends SubDependencyFactory {

        public SqlAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getDriver() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("sql.android.driver");
        }
     ...
     */
    @Deprecated
    public static class SqlCoroutinesLibraryAccessors extends SubDependencyFactory {

        public SqlCoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getExtensions() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("sql.coroutines.extensions");
        }
     ...
     */
    @Deprecated
    public static class SqlJvmLibraryAccessors extends SubDependencyFactory {

        public SqlJvmLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
     ...
     */
    @Deprecated
    public static class SqlNativeLibraryAccessors extends SubDependencyFactory {

        public SqlNativeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getDriver() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("sql.native.driver");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>foundationLayoutAndroid</b> with value <b>1.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktorClient</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sqlDelight</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.activityCompose</b> with value <b>1.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose</b> with value <b>1.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
